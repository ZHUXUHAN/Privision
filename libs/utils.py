...
FONT10 = ImageFont.truetype(file_pth + '/../files/fonts/Arial.ttf', 10)
FONT15 = ImageFont.truetype(file_pth + '/../files/fonts/Arial.ttf', 15)
FONT20 = ImageFont.truetype(file_pth + '/../files/fonts/Arial.ttf', 20)
FONT30 = ImageFont.truetype(file_pth + '/../files/fonts/Arial.ttf', 30)
